...
public class TexturePainter : MonoBehaviour {
	...
	bool HitTestUVPosition(ref Vector3 uvWorldPosition){
		...
		//Ray cursorRay = Physics.Raycast(brushCursor.transform.position, Vector3.down, out hit, 50f);//brushCursor.transform.position;//sceneCamera.ScreenPointToRay (cursorPos);
		if (Physics.Raycast(brushCursor.transform.position, Vector3.down, out hit, 50f))
        {
